...
"Cфte d’Ivoire":"Кейт-д'Ивуар",
"Cameroon":"Камерун",
"Congo, The Democratic Republic of the":"Народная Республика Конго",
"Congo":"Конго",
"Comoros":"Коморы",
...
countryOceania: {					//Oceania
"American Samoa":"Американская Самоа",
"Australia":"Австралия", 
"Cocos (Keeling) Islands":"    Кокосовые острова (острова Килинг) ",
"Cook Islands":"острова Кука",
"Christmas Island":"остров Рождества, остров Кристмас",
...
"countrySouth America": {			// South America
"Argentina":"Аргентина",
"Bolivia":"Боливия",
"Brazil":"Бразилия",
"Chile":"Чили",
...
"Ainu":"Айну",
"Asami":"???",
"Assyrian":"Ассирийский",
"Ami":"???",
"Atayal":"???",
"Bajad":"???",
"Balochi":"Белуджский",
"Bakhtyari":"Бахтиярский",
"Bali":"Бали",
"Banja":"???",
"Batakki":"???",
"Bhojpuri":"Бходжпури",
...
"Chakma":"Чакма",
"Chinese":"Китайский",
"Canton Chinese":"Кантонский Китайский",
"Chin":"???",
"Chiu chau":"???",
...
"Madura":"Мадурский",
"Man":"???",
"Mandarin Chinese":"Мандаринский Китайский",
"Mon":"???",
"Maithili":"Майтхили",
"Malay-English":"Малайский-Английский",
"Malajalam":"Малайялам",
"Marathi":"Маратхи",
"Marma":"???",
...
"Maranao":"Маранао",
"Mantљu":"???",
"Mazandarani":"Мазандеранский",
"Miao":"Мяо",
"Min":"???",
"Minangkabau":"Минангкабау",
"Mixed Languages":"Смешанные языки",
...
"Pilipino":"Пилиппино",
"Persian":"Персидский",
"Philippene Languages":"Филиппинские языки",
"Portuguese":"Портулальский",
"Puyi":"Пу И",
"Punjabi":"???",
"Rakhine":"???",
"Russian":"Русский",
...
"Waray-waray":"Варайский",
"Yi":"???",
"Zhuang":"Чжуан"
},

langEurope: {						// Europe lang
"Albaniana":"Албанский",
"Greek":"Греческий",
...
"Polish":"Польский",
"Romanian":"Румынский",
"Serbo-Croatian":"Сербо-Хоравтский",
"Slovene":"Словенский",
"Turkish":"Турецкий",
...
"Estonian":"Эстонский",
"Saame":"Саамский",
"Southern Slavic Languages":"Южно-Славацкие языки",
...
"Tatar":"Татарский",
"Udmur":"Удмурдский",
"Czech and Moravian":"Чешский и Моравский",
"Ukrainian and Russian":"Украинский и Русский",
"Basque":"Баскский",
"Galecian":"Галисийский",
"Romansh":"Романшский",
"Gaeli":"Гаэльский",
"Kymri":"Кимрский"
},
...
"Nizni Novgorod":"Нижний Новгород",
"Jekaterinburg":"Екатеринбург",
"Samara":"Самара",
"Omsk":"Омск",
"Kazan":"Казань",
"Ufa":"Уфа",
"Tљeljabinsk":"Челябинск",
...
"Orenburg":"Оренбург",
"Lipetsk":"Липецк",
"Nabereznyje Tљelny":"Набережные Челны",
"Tula":"Тула",
"Tjumen":"Тюмень",
"Kemerovo":"Кемерово",
"Astrahan":"Астрахань",
...
"Kirov":"Киров",
"Ivanovo":"Иваново",
"Tљeboksary":"Чебоксары",
"Brjansk":"Брянск",
"Tver":"Тверь",
"Kursk":"Курск",
"Magnitogorsk":"Магнитогорск",
"Kaliningrad":"Калининград",
"Nizni Tagil":"Нижний Тагил",
"Murmansk":"Мурманск",
"Ulan-Ude":"Улан-Удэ",
"Kurgan":"Курган",
...
"Kaluga":"Калуга",
"Vladimir":"Владимир",
"Mahatљkala":"Махачкала",
"Tљerepovets":"Череповецк",
"Saransk":"Саранск",
"Tambov":"Тамбов",
...
"Angarsk":"Ангарск",
"Joљkar-Ola":"Йошкар-ола",
"Rybinsk":"Рыбинск",
"Prokopjevsk":"Прокопьевск",
"Niznevartovsk":"Нижневартовск",
"Naltљik":"Нальчик",
"Syktyvkar":"Сыктывкар",
"Severodvinsk":"Северодвинск",
"Bijsk":"Бийск",
"Niznekamsk":"Нижнекамск",
"Blagoveљtљensk":"Благовещенск",
"Љahty":"Ахты",
"Staryi Oskol":"Старый Оскол",
"Zelenograd":"Зеленоград",
"Balakovo":"Балаково",
"Novorossijsk":"Нороссийск",
"Pihkova":"Псков",
"Zlatoust":"Златоуст",
"Jakutsk":"Якутск",
"Podolsk":"Подольск",
"Petropavlovsk-Kamtљatski":"Петропавловск-Камчатский",
"Kamensk-Uralski":"Каменск-Уральский",
"Engels":"Энгельс", 
"Syzran":"Сызрань",
"Grozny":"Грозный",
"Novotљerkassk":"Новочеркасск",
"Berezniki":"Березники",
"Juzno-Sahalinsk":"Южно-Сахалинск",
...
"Kamyљin":"Камышин",
"Novotљeboksarsk":"Новочебоксарск",
"Tљerkessk":"Черкесск",
"Atљinsk":"Ачинск",
"Magadan":"Магадан",
"Mitљurinsk":"Мичуринск",
"Kislovodsk":"Кисловодск",
"Jelets":"Елец",
"Seversk":"Северск",
"Noginsk":"Ногинск",
"Velikije Luki":"Великие Луки",
"Novokuibyљevsk":"Новокуйбышевск",
"Neftekamsk":"Нефтекамск",
"Leninsk-Kuznetski":"Ленинск-Кузнецкий",
"Oktjabrski":"Октябрьский",
"Sergijev Posad":"Сергиев-Посад",
"Arzamas":"Арзамас",
"Kiseljovsk":"Киселёвск",
"Novotroitsk":"Новокуйбышевск",
"Obninsk":"Обнинск",
"Kansk":"Канск",
"Glazov":"Глазов",
"Solikamsk":"Соликамск",
...
"Љtљolkovo":"Щёлково",
"Mezduretљensk":"Междуреченск",
"Usolje-Sibirskoje":"Усолье-Сиби́рское",
"Elista":"Элиста",
"Novoљahtinsk":"Новошахтинск ",
"Votkinsk":"Воткинск",
"Kyzyl":"Кузул",
"Serov":"Серов",
"Zelenodolsk":"Зеленодольск",
"Zeleznodoroznyi":"Железнодорожный",
"Kineљma":"Кинешма",
"Kuznetsk":"Кузнецк",
"Uhta":"Ухта",
"Jessentuki":"Ессентуки",
"Tobolsk":"Тобольск",
"Neftejugansk":"Нефтеюганск",
"Bataisk":"Батайск",
"Nojabrsk":"Ноябрьск",
"Balaљov":"Балашов",
"Zeleznogorsk":"Железногорск",
"Zukovski":"Жуковски",
"Anzero-Sudzensk":"Анжеро-Судженск",
"Bugulma":"Бугульма",
"Zeleznogorsk":"Железногорск",
...
"Vorkuta":"Воркута",
"Derbent":"Дербент",
"Kirovo-Tљepetsk":"Кирово-Чепецк",
"Krasnogorsk":"Красногорск",
"Klin":"Клин",
"Tљaikovski":"Чайковский",
...
"Kцkshetau":"Кокшетау",
"Rudnyy":"Рудный",
"Taldyqorghan":"Талдыкорган",
"Zhezqazghan":"Джезказган"
},
...
cityUKR : 	{						// cityUKR
"Kyiv":"Киев",
"Harkova [Harkiv]":"Харьков",
"Dnipropetrovsk":"Днепропетровск",
"Donetsk":"Донецк",
"Odesa":"Одесса",
"Zaporizzja":"Запорожье",
"Lviv":"Львов",
...
"Pultava [Poltava]":"Полтава",
"Tљernigiv":"Чернигов",
"Tљerkasy":"Черкассы",
"Gorlivka":"Горловка",
"Zytomyr":"Житомир",
"Sumy":"Сумы",
"Dniprodzerzynsk":"Днепродзержинск",
"Kirovograd":"Кировоград",
"Hmelnytskyi":"Хмельницкий",
"Tљernivtsi":"Черновцы",
"Rivne":"Ровно",
"Krementљuk":"Кременьчук",
...
"Berdjansk":"Бердянск",
"Pavlograd":"Павлоград ",
"Sjeverodonetsk":"Северодонецк",
"Slovjansk":"Славянск",
"Uzgorod":"Ужгород",
"Altљevsk":"Алчевск",
"Lysytљansk":"Лисичанск",
"Jevpatorija":"Евпатория",
"Kamjanets-Podilskyi":"Каменец-Подольский",
"Jenakijeve":"Енакиево",
"Krasnyi Lutљ":"Красный луч",
"Stahanov":"Стаханов",
"Oleksandrija":"Александрия",
"Konotop":"Конотоп",
"Kostjantynivka":"Константиновка",
"Berdytљiv":"Бердичев",
"Izmajil":"Измаил",
"Љostka":"Шостка",
"Uman":"Умань",
...
$scope.ToRU = function (_scope,arrname,dictname,prop) {
				console.log("TranslateToRU:--arrname='%s'---dictname='%s'---prop='%s'---->",arrname,dictname,prop);
				angular.forEach(_scope[arrname], function (en_item, index) {		
					((_scope[arrname])[index])[prop] = UniDic.en2ru(en_item[prop],dictname); // no UniDic !!!
				});
};
*/
...
$scope.btnToolbarNorm = {
	...
	mouseoverToolbar: function ($this){
		//console.log("mouseoverToolbar:-------%s-------->",$this.attr("id") );
		...
		this.idToolbarTimer = $window.setTimeout(function()			// setTimeout
		{
			if ($this.hasClass("btnToolbarNorm"))
			{
				$this.animate(
								{
									fontSize: '16px',
									//fontFamily: 'Georgia, "Times New Roman", Times, serif' //fontWeight: 600
								},
								300
								, 
								function () 
    ...
    mouseoutToolbar: function ($this){
		//console.log("mouseoutToolbar:-------%s-------->",$this.attr("id") );
		...
		if ($this.hasClass("btnToolbarHover"))
		{
			if ($this.hasClass("btnToolbarNorm"))
			{
					$this.animate(
									{
									fontSize: '12px'
									//fontFamily: 'Arial, Helvetica, sans-serif'  //fontWeight: 500
									},
									300, 
										function () //если требуется, то сделать кнопку Disabled
										{
											$this.removeClass("btnToolbarHover");
										  //if(SimleToolBar.localDiction.RemoveParam(this.id + 'DisableAfterMouseOut'))
										  //{
										  // SimleToolBar.disable("#" + this.id);
										  //}
										}								  
									)
			}// End btnToolbarNorma
...
*/	
		/*
		//console.log("Event type:%s  id:%s ",e.type, e.target.id);
		//for (var prop in e.target) {
		//	console.log("Name: " + prop + " Value: " + e.target[prop]);
		//\}
		*/
...
/*
	createTable: function (arr) {				// UniPopup.createTable($scope._scope.arrayname);
	//    params:
	//                                            {   -tableId: 'popUpTable',
	//                                                tableClass: "tgTable",
	//                                                cellClass: "tgCell",
	//                                                parentId: "tgPopup"/"slPopup",
	//                                                -isShowTableHeader: false,
	//												  -rowslength: 0	
	//                                            });
	console.log("UniPopup.createTable---arr.length='%s'---->", arr.length);
	var content = '';
	if (arr.length) {
		content += '<table class="tgTable"><tbody>';
		for (var i = 0; i < arr.length; i++) {
			content += '<tr><td id="td' + i + '" class="tgCell">' + arr[i].Name + '</td></tr>';
		}
		content += '/<tbody></table>';
	}
	console.log("UniPopup.createTable:<--%s--",content);
	//document.getElementById(params.parentId).innerHTML = content;
	return content;
},
*/	
